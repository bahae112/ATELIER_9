<?php
include "C:/xampp/htdocs/Atelier_9/model/utilisateur.php";
...
class DaoUtilisateur {
    ...
    public function saveUser(Utilisateur $user): void {
        $stm = $this->dbh->prepare("INSERT INTO utilisateur (email, password, name, birthdate, telephone, visibility, website, description) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
